...
void eyediag::processing()
  {
        ...
        if(x<lastx) // Beginnt neue Polylinie wenn das Ende der Zeichenebene erreicht wurde
	{
	  ...
	  ss1 << "points=\"" << endl;
        ...
        // Normierung des Signals auf 1 - anschlie�ende Pixelberechnung
...
void eyediag::finish()
  {
    ...
    // Abschluss des SVG-Dokuments und schlie�en des Filehandles
    output << "</svg>";
    output.close();
  }
...
void scatter:: finish()
  {
    string s=ss1.str(); // Erstellen des Polyline-Strings mit anschlie�ender Ausgabe
    output << "<polyline fill=\"none\" stroke=\"black\" stroke-width=\"1px\"" << endl;
